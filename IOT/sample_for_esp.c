...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (message == "put appropiate message") {
    digitalWrite(ledPin, HIGH);  // Turn LED ON
  } else if (message == "put appropriate message") {
...
void reconnect() {
  while (!client.connected()) {
    ...
    const char* topic = "put/appropriate/topic"; // TODO: The topic will be "led" under your id under "cse" under "buet"
